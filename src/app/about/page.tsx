      ...
      <div className=''>
        ...
        <section className='flex flex-row justify-between items-center px-60 py-14 gap-20'>
          <div className='flex flex-col gap-8'>
            ...
            <p>
              Je m'appelle GONTHIER Thomas, j'ai 21 ans, et je suis passionné par le développement depuis très longtemps. De nature curieuse et toujours désireux de progresser, j'ai développé mes compétences de manière <span className='font-bold'>autodidacte</span> ainsi qu'à travers mes formations.
            </p>
            ...
            <p>
              J'ai donc orienté mes études vers le domaine du développement, en commençant par des cours théoriques, avant de m'orienter vers l'alternance pour acquérir plus de compétences et de responsabilités. Je me suis spécialisé dans le <span className='font-bold'>développement front-end</span>
              , travaillant sur des <span className='font-bold'>sites web</span>, des <span className='font-bold'>applications web</span>, et même des <span className='font-bold'>applications mobiles</span>.
            </p>
            <p>
              Récemment, je me suis lancé en <span className='font-bold'>freelance</span> en complément de mon alternance, une expérience enrichissante pleine de surprises, je le sens ! 😄
            </p>
          </div>
        ...
        <section className='flex flex-col lg:flex-row justify-between items-center px-8 sm:px-16 lg:px-60 py-14 gap-20'>
          <div className='px-8 py-10'>
            <div className='flex flex-col gap-4'>
              <h3 className='text-xl font-bold'>Education & Work Experience</h3>
            </div>
          </div>
        </section>
      </div>
