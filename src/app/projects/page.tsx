        ...
        <>
            ...
            <div className="px-8 py-20 max-w-md md:max-w-2xl mx-auto">
                <div className="flex flex-col gap-4 items-center justify-center">
                    <div className="rounded-full px-2 py-1 border border-primary-300 dark:border-primary-600 bg-primary-100 dark:bg-primary-700 text-primary-700 dark:text-primary-300 flex flex-row items-center justify-between">
                    ...
                    <div className="flex flex-row items-center gap-4 justify-center">
                        <a href="mailto:" className="bg-primary-600 dark:bg-primary-500 hover:bg-primary-500 dark:hover:bg-primary-600 text-slate-50 text-lg font-bold px-2.5 py-2 rounded-xl flex items-center justify-center">Me contacter</a>
                    </div>
                </div>
            </div>
